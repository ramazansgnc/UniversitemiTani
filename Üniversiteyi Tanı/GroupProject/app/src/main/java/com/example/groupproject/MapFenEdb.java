...
public class MapFenEdb extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSearchText.setText("harran üniversitesi fen edebiyat fakültesi");
    ...
    public void geoLocate(){// aranılan yere yönlendirme
        ...
        Geocoder geocoder = new Geocoder(MapFenEdb.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(MapFenEdb.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initMap(){// Haritanın yüklenmesi
        ...
        mapFragment.getMapAsync(MapFenEdb.this);
    }
