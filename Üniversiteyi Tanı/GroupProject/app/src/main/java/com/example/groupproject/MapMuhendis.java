...
public class MapMuhendis extends AppCompatActivity implements OnMapReadyCallback{
 ...
 @Override
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      sureSayac();
        ...
        mSearchText.setText("Harran Üniversitesi Mühendislik Fakültesi");
    ...
    public void geoLocate(){// aranılan yere yönlendirme
        ...
        Geocoder geocoder = new Geocoder(MapMuhendis.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(MapMuhendis.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initMap(){// Haritanın yüklenmesi
        ...
        mapFragment.getMapAsync(MapMuhendis.this);
    }
