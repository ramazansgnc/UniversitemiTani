...
public class MapKtp extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSearchText.setText("harran üniversitesi el battani kütüphanesi");
    ...
    public void geoLocate(){// aranılan yere yönlendirme
        ...
        Geocoder geocoder = new Geocoder(MapKtp.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(MapKtp.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initMap(){// Haritanın yüklenmesi
        ...
        mapFragment.getMapAsync(MapKtp.this);
    }
