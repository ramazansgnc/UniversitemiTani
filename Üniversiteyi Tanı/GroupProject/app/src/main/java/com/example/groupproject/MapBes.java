...
public class MapBes extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSearchText.setText("Gülveren, Mehmet Arabacı Beden Eğitmi ve Spor Yüksekokulu, 63290 Şanlıurfa Merkez/Şanlıurfa");
    ...
    public void geoLocate(){// aranılan yere yönlendirme
        ...
        Geocoder geocoder = new Geocoder(MapBes.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(MapBes.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initMap(){// Haritanın yüklenmesi
        ...
        mapFragment.getMapAsync(MapBes.this);
    }
