...
public class MapRektr extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSearchText.setText("Gülveren, Harran Üniversitesi Rektörlük binası, 63290 Haliliye/Şanlıurfa");
    ...
    public void geoLocate(){// aranılan yere yönlendirme
        ...
        Geocoder geocoder = new Geocoder(MapRektr.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(MapRektr.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void initMap(){// Haritanın yüklenmesi
        ...
        mapFragment.getMapAsync(MapRektr.this);
    }
